...
public class MCreatorDarkDesert extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkdesert")
	public static final BiomeGenCustom biome = null;

	public MCreatorDarkDesert(Elementsbasicrpgmod instance) {
		super(instance, 31);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			...
			topBlock = MCreatorDarkSand.block.getDefaultState();
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == MCreatorDarkSand.block.getDefaultState().getBlock() || ground == MCreatorDarkStone.block.getDefaultState()
							.getBlock()) && (ground2 == MCreatorDarkSand.block.getDefaultState().getBlock() || ground2 == MCreatorDarkStone.block
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == Blocks.AIR.getDefaultState().getBlock()
					|| blockType == Blocks.AIR.getDefaultState().getBlock() || blockType == MCreatorDarkSand.block.getDefaultState().getBlock()
