...
public class MCreatorRedMushroom extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:redmushroom")
	public static final Block block = null;

	public MCreatorRedMushroom(Elementsbasicrpgmod instance) {
		super(instance, 192);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:redmushroom", "inventory"));
	}
