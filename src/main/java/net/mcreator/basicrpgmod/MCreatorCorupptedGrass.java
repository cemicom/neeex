...
public class MCreatorCorupptedGrass extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corupptedgrass")
	public static final Block block = null;

	public MCreatorCorupptedGrass(Elementsbasicrpgmod instance) {
		super(instance, 56);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:corupptedgrass",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("corupptedgrass");
			setRegistryName("corupptedgrass");
		}
