...
public class MCreatorMyticForest2 extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:myticforest2")
	public static final BiomeGenCustom biome = null;

	public MCreatorMyticForest2(Elementsbasicrpgmod instance) {
		super(instance, 149);
	}
