...
public class MCreatorMyticMountains extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:myticmountains")
	public static final BiomeGenCustom biome = null;

	public MCreatorMyticMountains(Elementsbasicrpgmod instance) {
		super(instance, 100);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Mytic Mountains").setRainfall(0.5F).setBaseHeight(0F).setWaterColor(-3407668).setHeightVariation(2F)
					.setTemperature(0.5F));
			setRegistryName("myticmountains");
