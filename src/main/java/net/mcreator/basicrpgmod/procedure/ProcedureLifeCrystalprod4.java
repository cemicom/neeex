...
public class ProcedureLifeCrystalprod4 extends ElementsBasicRPGmod.ModElement {
	public ProcedureLifeCrystalprod4(ElementsBasicRPGmod instance) {
		super(instance, 18);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LifeCrystalprod4!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LifeCrystalprod4!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LifeCrystalprod4!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LifeCrystalprod4!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LifeCrystalprod4!");
			return;
		}
		...
		if ((((entity instanceof EntityPlayer)
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemLifeCrystal4.block, (int) (1)).getItem(), -1, (int) 1, null);
			if (!world.isRemote) {
