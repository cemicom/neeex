...
public class ProcedureShockEssanceFoodEaten extends ElementsBasicRPGmod.ModElement {
	public ProcedureShockEssanceFoodEaten(ElementsBasicRPGmod instance) {
		super(instance, 154);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ShockEssanceFoodEaten!");
			return;
		}
