...
public class ProcedureLifeCrystalPORD1 extends ElementsBasicRPGmod.ModElement {
	public ProcedureLifeCrystalPORD1(ElementsBasicRPGmod instance) {
		super(instance, 8);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LifeCrystalPORD1!");
			return;
		}
		...
		if ((new Object() {
			...
			if (((entity instanceof EntityPlayer)
				...
				if (((entity instanceof EntityPlayer)
					...
					if (entity instanceof EntityLivingBase)
						((EntityLivingBase) entity)
								.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, (int) 90000000, (int) 20, (false), (false)));
				} else {
					if (((entity instanceof EntityPlayer)
						...
						if (entity instanceof EntityLivingBase)
							((EntityLivingBase) entity)
									.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, (int) 90000000, (int) 16, (false), (false)));
					} else {
						if (((entity instanceof EntityPlayer)
							...
							if (entity instanceof EntityLivingBase)
								((EntityLivingBase) entity)
										.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, (int) 90000000, (int) 8, (false), (false)));
						} else {
							if (((entity instanceof EntityPlayer)
								...
								if (entity instanceof EntityLivingBase)
									((EntityLivingBase) entity)
											.addPotionEffect(new PotionEffect(MobEffects.HEALTH_BOOST, (int) 90000000, (int) 4, (false), (false)));
							} else {
								if (((entity instanceof EntityPlayer)
									...
									if (entity instanceof EntityLivingBase)
										((EntityLivingBase) entity).addPotionEffect(
												new PotionEffect(MobEffects.HEALTH_BOOST, (int) 90000000, (int) 2, (false), (false)));
								} else {
									if (entity instanceof EntityPlayer)
