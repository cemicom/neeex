...
public class MCreatorDarkSpore extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkspore")
	public static final Block block = null;

	public MCreatorDarkSpore(Elementsbasicrpgmod instance) {
		super(instance, 65);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:darkspore", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			Block block = this;
			{
				...
				MCreatorDarkSporeMobplayerCollidesWithPlant.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			Block block = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorDarkSporePlantDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
