...
public class MCreatorFrozenHeartha extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:frozenheartha")
	public static final Block block = null;

	public MCreatorFrozenHeartha(Elementsbasicrpgmod instance) {
		super(instance, 170);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:frozenheartha",
				"inventory"));
	}
