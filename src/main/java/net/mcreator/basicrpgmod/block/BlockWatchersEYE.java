...
import net.mcreator.basicrpgmod.procedure.ProcedureCorupptedbushPlantDestroyedByPlayer;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

import java.util.Random;

@ElementsBasicRPGmod.ModElement.Tag
public class BlockWatchersEYE extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:watcherseye")
	public static final Block block = null;
	public BlockWatchersEYE(ElementsBasicRPGmod instance) {
		super(instance, 55);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("basicrpgmod:watcherseye", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCorupptedbushPlantDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
