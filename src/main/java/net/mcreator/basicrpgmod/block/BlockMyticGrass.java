...
public class BlockMyticGrass extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:myticgrass")
	public static final Block block = null;
	public BlockMyticGrass(ElementsBasicRPGmod instance) {
		super(instance, 70);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("myticgrass"));
