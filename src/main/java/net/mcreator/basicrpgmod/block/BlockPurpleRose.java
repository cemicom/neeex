...
public class BlockPurpleRose extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:purplerose")
	public static final Block block = null;
	public BlockPurpleRose(ElementsBasicRPGmod instance) {
		super(instance, 113);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:purplerose", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("purplerose");
			setRegistryName("purplerose");
		}
