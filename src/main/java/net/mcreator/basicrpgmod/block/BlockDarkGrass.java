...
public class BlockDarkGrass extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkgrass")
	public static final Block block = null;
	public BlockDarkGrass(ElementsBasicRPGmod instance) {
		super(instance, 22);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("darkgrass"));
