...
public class BlockGoldgrass extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:goldgrass")
	public static final Block block = null;
	public BlockGoldgrass(ElementsBasicRPGmod instance) {
		super(instance, 116);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:goldgrass", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("goldgrass");
			setRegistryName("goldgrass");
		}
