...
public class BlockDarkSand extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darksand")
	public static final Block block = null;
	public BlockDarkSand(ElementsBasicRPGmod instance) {
		super(instance, 30);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("darksand"));
