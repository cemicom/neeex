...
public class BlockGoldgrass2 extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:goldgrass2")
	public static final Block block = null;
	public BlockGoldgrass2(ElementsBasicRPGmod instance) {
		super(instance, 117);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:goldgrass2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("goldgrass2");
			setRegistryName("goldgrass2");
		}
