...
import net.mcreator.basicrpgmod.item.ItemCorupttedGrapes;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

import java.util.Random;

@ElementsBasicRPGmod.ModElement.Tag
public class BlockCorupptedbush extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corupptedbush")
	public static final Block block = null;
	public BlockCorupptedbush(ElementsBasicRPGmod instance) {
		super(instance, 53);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("basicrpgmod:corupptedbush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCorupttedGrapes.block, (int) (4)));
		}
