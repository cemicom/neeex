...
public class BlockDarkPlank extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkplank")
	public static final Block block = null;
	public BlockDarkPlank(ElementsBasicRPGmod instance) {
		super(instance, 28);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("darkplank"));
