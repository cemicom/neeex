...
import net.mcreator.basicrpgmod.procedure.ProcedureCorruptedThornsPlantDestroyedByPlayer;
import net.mcreator.basicrpgmod.procedure.ProcedureCORUPTEDThornsMobplayerCollidesWithPlant;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

import java.util.Random;

@ElementsBasicRPGmod.ModElement.Tag
public class BlockCorruptedThorns extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corruptedthorns")
	public static final Block block = null;
	public BlockCorruptedThorns(ElementsBasicRPGmod instance) {
		super(instance, 52);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("basicrpgmod:corruptedthorns", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("corruptedthorns");
			setRegistryName("corruptedthorns");
		}
		...
		public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCORUPTEDThornsMobplayerCollidesWithPlant.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCorruptedThornsPlantDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
