...
public class BlockCorupptedGrass extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corupptedgrass")
	public static final Block block = null;
	public BlockCorupptedGrass(ElementsBasicRPGmod instance) {
		super(instance, 56);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("basicrpgmod:corupptedgrass", "inventory"));
	}
