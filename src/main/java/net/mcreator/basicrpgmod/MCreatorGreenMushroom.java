...
public class MCreatorGreenMushroom extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:greenmushroom")
	public static final Block block = null;

	public MCreatorGreenMushroom(Elementsbasicrpgmod instance) {
		super(instance, 199);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:greenmushroom",
				"inventory"));
	}
