...
public class MCreatorPurpleVines extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:purplevines")
	public static final Block block = null;

	public MCreatorPurpleVines(Elementsbasicrpgmod instance) {
		super(instance, 111);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:purplevines", "inventory"));
	}
