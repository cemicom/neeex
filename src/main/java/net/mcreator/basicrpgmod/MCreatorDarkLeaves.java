...
public class MCreatorDarkLeaves extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkleaves")
	public static final Block block = null;

	public MCreatorDarkLeaves(Elementsbasicrpgmod instance) {
		super(instance, 25);
	}
	...
	public static class BlockCustom extends Block {
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			Block block = this;
			{
				...
				MCreatorDarkLeavesBlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
