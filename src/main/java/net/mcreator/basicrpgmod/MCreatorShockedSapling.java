...
public class MCreatorShockedSapling extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:shockedsapling")
	public static final Block block = null;

	public MCreatorShockedSapling(Elementsbasicrpgmod instance) {
		super(instance, 171);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:shockedsapling",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side,
			...
			Block block = this;
			{
				...
				MCreatorShockedSaplingPlantRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
