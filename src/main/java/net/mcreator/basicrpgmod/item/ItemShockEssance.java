...
import net.mcreator.basicrpgmod.procedure.ProcedureShockedFoodEaten;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

@ElementsBasicRPGmod.ModElement.Tag
public class ItemShockEssance extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:shockessance")
	public static final Item block = null;
	public ItemShockEssance(ElementsBasicRPGmod instance) {
		super(instance, 154);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureShockedFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
