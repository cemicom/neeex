...
public class ItemDarkWoodsAxe extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkwoodsaxe")
	public static final Item block = null;
	public ItemDarkWoodsAxe(ElementsBasicRPGmod instance) {
		super(instance, 33);
	}
	...
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("DARKWOODSAXE", 2, 50, 5f, 1f, 11), effective_items_set);
