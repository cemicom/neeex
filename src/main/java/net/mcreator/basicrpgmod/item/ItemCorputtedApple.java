...
import net.mcreator.basicrpgmod.procedure.ProcedureCorputtedAppleFoodEaten;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

@ElementsBasicRPGmod.ModElement.Tag
public class ItemCorputtedApple extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corputtedapple")
	public static final Item block = null;
	public ItemCorputtedApple(ElementsBasicRPGmod instance) {
		super(instance, 53);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureCorputtedAppleFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
