...
public class ItemFrozenAxe extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:frozenaxe")
	public static final Item block = null;
	public ItemFrozenAxe(ElementsBasicRPGmod instance) {
		super(instance, 176);
	}
	...
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("FROZENAXE", 1, 190, 5f, 1.3f, 14), effective_items_set);
			this.attackDamage = 1.3f;
			this.attackSpeed = -3f;
		}
