...
public class ItemGoldAxe extends ElementsBasicRPGmod.ModElement {

	@GameRegistry.ObjectHolder("basicrpgmod:goldaxe")
	public static final Item block = null;

	public ItemGoldAxe(ElementsBasicRPGmod instance) {
		super(instance, 76);
	}
	...
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("GOLDAXE", 0, 90, 3f, 1f, 11), effective_items_set);
