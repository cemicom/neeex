...
import net.mcreator.basicrpgmod.procedure.ProcedureYellowBigMushroomFoodEaten;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

@ElementsBasicRPGmod.ModElement.Tag
public class ItemYellowBigMushroom extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:yellowbigmushroom")
	public static final Item block = null;
	public ItemYellowBigMushroom(ElementsBasicRPGmod instance) {
		super(instance, 196);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureYellowBigMushroomFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
