...
public class ItemDarkHoe extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkhoe")
	public static final Item block = null;
	public ItemDarkHoe(ElementsBasicRPGmod instance) {
		super(instance, 46);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemHoe(EnumHelper.addToolMaterial("DARKHOE", 3, 441, 8f, 0f, 21)) {
