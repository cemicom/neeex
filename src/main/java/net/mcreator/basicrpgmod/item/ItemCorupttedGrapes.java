...
import net.mcreator.basicrpgmod.procedure.ProcedureCorupttedGrapesFoodEaten;
import net.mcreator.basicrpgmod.ElementsBasicRPGmod;

@ElementsBasicRPGmod.ModElement.Tag
public class ItemCorupttedGrapes extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:corupttedgrapes")
	public static final Item block = null;
	public ItemCorupttedGrapes(ElementsBasicRPGmod instance) {
		super(instance, 54);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureCorupttedGrapesFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
