...
public class ItemMoltenAxe extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:moltenaxe")
	public static final Item block = null;
	public ItemMoltenAxe(ElementsBasicRPGmod instance) {
		super(instance, 139);
	}
	...
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("MOLTENAXE", 1, 190, 5f, 1.3f, 14), effective_items_set);
