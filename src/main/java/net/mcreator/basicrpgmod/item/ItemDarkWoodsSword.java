...
public class ItemDarkWoodsSword extends ElementsBasicRPGmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkwoodssword")
	public static final Item block = null;
	public ItemDarkWoodsSword(ElementsBasicRPGmod instance) {
		super(instance, 34);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSword(EnumHelper.addToolMaterial("DARKWOODSSWORD", 2, 50, 5f, 0.5f, 11)) {
			@Override
