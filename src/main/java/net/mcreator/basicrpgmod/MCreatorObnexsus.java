...
public class MCreatorObnexsus extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:obnexsus")
	public static final Block block = null;

	public MCreatorObnexsus(Elementsbasicrpgmod instance) {
		super(instance, 24);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:obnexsus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("obnexsus");
			setRegistryName("obnexsus");
		}
