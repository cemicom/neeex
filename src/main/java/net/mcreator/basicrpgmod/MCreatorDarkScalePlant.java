...
public class MCreatorDarkScalePlant extends Elementsbasicrpgmod.ModElement {
	@GameRegistry.ObjectHolder("basicrpgmod:darkscaleplant")
	public static final Block block = null;

	public MCreatorDarkScalePlant(Elementsbasicrpgmod instance) {
		super(instance, 69);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("basicrpgmod:darkscaleplant",
				"inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			Block block = this;
			{
				...
				MCreatorDarkScalePlantPlantDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
